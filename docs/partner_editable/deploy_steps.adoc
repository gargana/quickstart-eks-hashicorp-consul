...
[cols=3*]
|===
^|http://qs_launch_link[Deploy {partner-product-short-name} into a new VPC on AWS, role=external, window=_blank]
^|http://qs_launch_link[Deploy {partner-product-short-name} into an existing VPC on AWS, role=external, window=_blank]
^|http://qs_launch_link[Deploy {partner-product-short-name} into an existing EKS cluster on AWS, role=external, window=_blank]

^|http://qs_template_link[View template, role=external, window=_blank]
^|http://qs_template_link[View template, role=external, window=_blank]
^|http://qs_template_link[View template, role=external, window=_blank]
|===
